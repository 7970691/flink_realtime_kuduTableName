...
import com.xm4399.util.KuduUtil;
import com.xm4399.util.ListAllSubTableName;
...
public class KuduSink extends RichSinkFunction<ConsumerRecord<String,String>> {
    ...
    //对每条数据进行处理
    public void processEveryRow(ConsumerRecord<String,String> row , KuduUtil kuduUtil, String address, String username,
                                String password, String dbName, String tableName, String isSubTable, String isRealtime, String kuduTableName) throws KuduException {
